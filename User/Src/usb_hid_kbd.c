...
static const uint8_t config_descriptor[] = {
    ...
    HID_KEYBOARD_DESCRIPTOR_INIT(0x00, 0x01, HID_KEYBOARD_REPORT_DESC_SIZE, HID_INT_EP, HID_INT_EP_SIZE,
                                 HID_INT_EP_INTERVAL),
};
...
void usb_hid_kbd_init(uint8_t busid, uintptr_t reg_base)
{
    ...
    usbd_add_interface(
        busid, usbd_hid_init_intf(busid, &intf0, hid_keyboard_report_desc, HID_KEYBOARD_REPORT_DESC_SIZE));
